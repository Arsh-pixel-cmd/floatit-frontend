      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4 backdrop-blur-sm" onClick={() => setShowModal(false)}>
          <div className="bg-white w-[380px] rounded-[24px] p-6 shadow-2xl relative" onClick={(e) => e.stopPropagation()}>
            ...
            <button onClick={handleSignup} disabled={signupLoading} className="w-full bg-[#2945D1] text-white rounded-xl py-2.5 text-[12px] font-semibold hover:bg-blue-700 transition disabled:opacity-50">{signupLoading ? 'Creating...' : 'Create Account'}</button>
